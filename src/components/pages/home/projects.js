...
const projects = [
  {
    ...
    desc: `Website, created during my first internship, which utilized
  ...
  },
  {
    ...
    desc: `Enjoyable side project that was created to experiment with more
  ...
  },
  {
    ...
    desc: `Data analytics project completed during my time at the Illinois
      ...
      <div className='container-fluid'>
        ...
        <div className='row'>
          {projects.map((project) => {
            return (
              <div className='col-sm-4 col-md-4 text-center' key={project.id}>
